...
##### (2021-07 ~ ing) - Kotlin, MVVM, LiveData, Coroutine, Retrofit2 + OKHttp(Response방식 - 비동기처리), SNS Login API(Google, Kakao, Naver), IamPort 연동(결제 서비스), JavaScriptInterface In WebView
